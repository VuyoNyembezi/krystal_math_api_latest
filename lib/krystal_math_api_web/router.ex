defmodule KrystalMathApiWeb.Router do
  ...
  scope "/api/auth", KrystalMathApiWeb do
    ...
    get "/projects/operational/search/all",
        ProjectController,
        :projects_operational_category_search
    ...
    get "/projects/team/operational_types/search",
        ProjectController,
        :team_search_operational_projects_project_type

    get "/projects/team/strategic_types/search",
        ProjectController,
        :team_search_strategic_projects_project_type
    ...
    get "/projects/operational/un_assigned/all",
        ProjectController,
        :all_un_assigned_operational_projects

    get "/projects/strategic/un_assigned/all",
        ProjectController,
        :all_un_assigned_strategic_projects
    ...
    get "/team/projects/category_and_project_type/all",
        ProjectController,
        :team_projects_by_type_and_category
  ...
  scope "/api/auth", KrystalMathApiWeb do
    ...
    get "/live_issues/search", LiveIssueController, :all_live_issues_search

    # All Live Issues Overview (acitive, not active, completed ,etc)
    get "/live_issues", LiveIssueController, :all_live_issues_overview
    # team
    # search

    get "/live_issues/team/search", LiveIssueController, :team_live_issues_search

    # Team Live Issues Statuses
    get "/team/live_issues/status/all", LiveIssueController, :get_all_team_live_issuses_status

    #  Team Live View projects 
    get "/team/live_issues", LiveIssueController, :team_live_issues_overview

    # Create live issue
    post "/create/live_issues", LiveIssueController, :create_new_live_issue
    # update live issue
    put "/live_issue/main/update", LiveIssueController, :update_live_issue
    put "/live_issue/update", LiveIssueController, :update_live_issue_status
    # delete live isse
    delete "/live_issue/delete", LiveIssueController, :delete_live_issue

    # COUNTER ###
    # Live Issues Counters
    get "/live_issues/active/count", LiveIssueController, :active_live_issues_counter
    # Overall Counter
    get "/live_issues/count/overview", LiveIssueController, :live_issues_counter
    get "/live_issues/count/statuses", LiveIssueController, :live_issue_status_counter

    # TEAM

    get "/live_issues/team/count/overview", LiveIssueController, :team_live_issues_counter
    # Team live issues Status Counters
    get "/live_issues/team/count/statuses", LiveIssueController, :team_live_statuses
  end
  ...
  scope "/api/auth", KrystalMathApiWeb do
    ...
    get "/project_assignment/team/project_type",
        AssignmentController,
        :get_team_project_assignments_project_type

    get "/project_assignment/project_type",
        AssignmentController,
        :get_project_assignments_project_type
    ...
    get "/project_assignment/over_due/team/all",
        AssignmentController,
        :overview_over_due_project_team_assigned
    ...
    get "/project_assignment/over_due/dev",
        AssignmentController,
        :get_over_due_project_dev_assigned

    # New Map Request endpoint
    get "/project_assignment/dev/all", AssignmentController, :overview_project_dev_assigned
    # Dev/User Over Project assignment
    get "/project_assignment/over_due/dev/all",
        AssignmentController,
        :overview_over_due_project_dev_assigned
    ...
    get "/operational/project_assignments/user/count",
        AssignmentController,
        :user_operational_project_assignment
