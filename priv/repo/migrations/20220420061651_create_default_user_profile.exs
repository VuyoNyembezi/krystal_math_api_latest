defmodule KrystalMathApi.Repo.Migrations.CreateDefaultUserProfile do
  ...
  def up do
    ...
    Repo.insert(%User{name: "TBA",last_name: "TBA",employee_code: "BT0000", email: "defaultuser@gmail.com",password: "@@@",password_reset: "@RESET_KEY",team_id: 1, user_role_id: 2,is_active: true, is_admin: false}, on_conflict: :replace_all, conflict_target: :employee_code)
    Repo.insert(%User{name: "TBA",last_name: "TBA",employee_code: "BT@#", email: "defaultpm@gmail.com",password: "@@@",password_reset: "@RESET_KEY",team_id: 1, user_role_id: 6,is_active: true, is_admin: false}, on_conflict: :replace_all, conflict_target: :employee_code)
